...
export const KNOWN_CSV_FORMATS: CsvFormat[] = [
  ...
  {
    id: 'schwab-trade-execution',
    name: 'Charles Schwab Trade Execution Format',
    description: 'Charles Schwab trade execution data with detailed order and routing information',
    ...
    fieldMappings: {
      ...
      'route': { tradeVoyagerField: 'orderRoute', dataType: 'string', required: false, examples: ['ARCA', 'NASDAQ', 'IEX'] },
      'bkrsym': { tradeVoyagerField: 'notes', dataType: 'string', required: false, examples: ['ARCX', 'IEX'] },
      ...
      'symb': { tradeVoyagerField: 'symbol', dataType: 'string', required: true, examples: ['TSLA', 'HOOD', 'AAPL'] },
      'qty': { tradeVoyagerField: 'orderQuantity', dataType: 'number', required: true, examples: ['600', '14', '30'] },
      'price': { tradeVoyagerField: 'limitPrice', dataType: 'number', required: false, examples: ['285.41', '43.23', '42.69'] },
      'time': { tradeVoyagerField: 'orderExecutedTime', dataType: 'date', required: true, transformer: 'parseOrderDateTime', examples: ['03/10/24 15:22:51', '04/22/25 12:08:30'] },
    },
    detectionPatterns: {
