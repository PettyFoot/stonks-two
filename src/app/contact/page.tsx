...
const metadata: Metadata = {
  title: 'Contact Us - Trade Voyager',
  description: 'Get in touch with Trade Voyager support team. Find answers to common questions about our trading analytics platform or submit a support request.',
  robots: {
    index: true,
    follow: true,
  },
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[var(--theme-primary-text)] max-w-3xl mx-auto">
            Have questions about Trade Voyager? Need help with your account or trading analytics? 
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">support@tradevoyager.com</p>
                  </div>
            ...
            <Card className="bg-gradient-to-r from-[var(--theme-tertiary)]/10 to-[var(--theme-green)]/10 border-[var(--theme-tertiary)]/30">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  Experience Trade Voyager with our demo mode - no signup required!
                </p>
                <Link href="/demo">
