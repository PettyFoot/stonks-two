...
export const metadata: Metadata = generateMetadata('dashboard', {
  title: 'Account Settings - Manage Your Profile & Subscription | Trade Voyager',
  description: 'Manage your account settings, profile information, subscription, billing, and security preferences in Trade Voyager.',
